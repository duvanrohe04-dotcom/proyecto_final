...
def perfil():
    ...
    if request.method == 'POST':
        ...
        if accion == 'datos':
            ...
            # Actualizar nombre y apellido en el usuario
            if nombre:
                current_user.nombre = nombre
            if apellido:
                current_user.apellido = apellido

            # Actualizar nombre completo en tabla cliente
            if nombre and apellido:
                nuevo_nombre_completo = f"{nombre} {apellido}"
                cliente.nombre = nuevo_nombre_completo
